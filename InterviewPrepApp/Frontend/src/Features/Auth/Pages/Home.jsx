...
const Cursor = ({ big }) => {
  ...
  return <>
    <div ref={ring} style={{ position:'fixed',zIndex:9999,pointerEvents:'none',top:0,left:0,width:44,height:44,borderRadius:'50%',border:'1px solid rgba(255,255,255,.6)',mixBlendMode:'difference',transition:'transform .15s cubic-bezier(.4,0,.2,1)',willChange:'transform' }} />
    ...
    <div className="h-root" style={{ cursor:'none' }}>
      ...
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .h-root { background:var(--bg);font-family:'Inter', sans-serif;color:var(--fg);overflow-x:hidden;min-height:100vh; }
        ...
        .h-nav__logo { display:flex;align-items:center;gap:10px;text-decoration:none;font-family:'Inter', sans-serif;font-size:16px;letter-spacing:.2em;color:var(--fg); }
        ...
        .h-nav__link { font-size:14px;font-weight:500;letter-spacing:.14em;text-transform:uppercase;color:var(--muted);text-decoration:none;transition:color .2s;position:relative; }
        ...
        .h-nav__in-link { font-size:14px;font-weight:500;letter-spacing:.12em;text-transform:uppercase;color:var(--muted);text-decoration:none;transition:color .2s; }
        .h-nav__in-link:hover { color:var(--fg); }

        .h-nav__cta { position:relative;display:flex;align-items:center;gap:6px;padding:11px 24px;border:1px solid rgba(255,255,255,.4);background:transparent;color:var(--fg);cursor:pointer;font-family:'Inter', sans-serif;font-size:14px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;transition:all .3s;overflow:hidden; }
        ...
        .h-idx { display:flex;align-items:center;gap:10px;font-family:'Bebas Neue', sans-serif;font-size:32px;letter-spacing:.2em;color:var(--muted);margin-bottom:40px;padding-top:140px; }
        ...
        .h-title-row__idx { font-family:'Bebas Neue', sans-serif;font-size:48px;letter-spacing:.18em;color:rgba(255,255,255,.1);align-self:flex-start;padding-top:8px; }
        ...
        .h-title-word {
          ...
          line-height:.88;letter-spacing:-.04em;color:var(--fg);
        }
        ...
        /* CTA pill */
        .h-cta-pill { position:relative;display:inline-flex;align-items:center;gap:10px;padding:18px 40px;border:1px solid #ffffff;cursor:pointer;overflow:hidden;font-family:'Inter', sans-serif;font-size:15px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:#05050d;transition:all .3s;box-shadow:0 8px 40px rgba(255,255,255,.1); }
        ...
        .h-marquee__item { display:flex;align-items:center;gap:14px;padding:0 28px;font-family:'Inter', sans-serif;font-size:12px;letter-spacing:.22em;text-transform:uppercase;color:rgba(200,200,220,.18);white-space:nowrap; }
        ...
        .h-metric__label { font-family:'Bebas Neue', sans-serif;font-size:20px;letter-spacing:.2em;color:var(--muted); }
        .h-metric__val { font-family:'Bebas Neue', sans-serif;font-size:88px;line-height:1;letter-spacing:-.01em;color:var(--fg);display:flex;align-items:baseline;gap:8px; }
        ...
        .h-section-eyebrow { font-family:'Bebas Neue', sans-serif;font-size:40px;letter-spacing:.1em;color:var(--muted);margin-bottom:80px;display:flex;gap:16px;align-items:center; }
        .h-section-eyebrow--center { justify-content:center; }
        .h-eyebrow-n { color:var(--p); }
        .h-section-title { font-family:'Inter', sans-serif;font-size:clamp(56px,7vw,96px);font-weight:900;line-height:.9;letter-spacing:-.03em;color:var(--fg);margin-bottom:80px;text-transform:uppercase; }
        ...
        .h-fpanel__title { font-family:'Inter', sans-serif;font-size:46px;letter-spacing:-.005em;line-height:1;color:var(--fg);margin-bottom:24px;display:flex;flex-direction:column; }
        ...
        .h-step__num { font-family:'Bebas Neue', sans-serif;font-size:80px;line-height:1;color:var(--fg);padding-top:4px; }
        .h-step__content { padding:0 48px; }
        .h-step__t { font-family:'Inter', sans-serif;font-size:30px;letter-spacing:.02em;color:var(--fg);margin-bottom:14px;line-height:1; }
        ...
        .h-term__body { padding:26px 30px 34px;font-family:'Inter', sans-serif;font-size:15px;line-height:1.9; }
        ...
        .h-banner__title { font-family:'Bebas Neue', sans-serif;font-size:clamp(80px,12vw,180px);line-height:1;letter-spacing:.02em;color:#ffffff;margin-bottom:32px;display:flex;flex-direction:column;align-items:center; }
        ...
        .h-banner__bigtext { position:absolute;bottom:-50px;left:50%;transform:translateX(-50%);font-family:'Bebas Neue', sans-serif;font-size:260px;letter-spacing:.1em;color:transparent;-webkit-text-stroke:1px rgba(255,255,255,.04);white-space:nowrap;user-select:none;pointer-events:none;z-index:1; }
        ...
        .h-footer__brand { display:flex;align-items:center;gap:10px;font-family:'Inter', sans-serif;font-size:14px;letter-spacing:.2em;color:var(--fg); }
