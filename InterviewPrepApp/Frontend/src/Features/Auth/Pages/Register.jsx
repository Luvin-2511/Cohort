  ...
  return (
    <div className="rx-root" style={{ cursor: 'none' }}>
      ...
      <div className="rx-bg">
        ...
        {[0,1,2].map(i => <div key={i} className={`rx-bg__orb rx-bg__orb--${i}`} />)}
      </div>
        ...
        <div className={`rx-left ${mounted ? 'rx-left--in' : ''}`}>
          ...
          <div className="rx-progress-art">
            <svg className="rx-progress-svg" viewBox="0 0 200 200">
              <circle cx="100" cy="100" r="80" fill="none" stroke="rgba(255,60,172,0.06)" strokeWidth="2" />
              <circle
              ...
              {[0,1,2,3,4,5,6,7].map(i => {
                ...
                return <circle key={i} cx={x} cy={y} r="2" fill="rgba(255,60,172,0.25)" />
              })}
            </svg>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rx-bg__grid {
          ...
          background-image:
            linear-gradient(rgba(255,60,172,0.025) 1px, transparent 1px),
            linear-gradient(90deg, rgba(255,60,172,0.025) 1px, transparent 1px);
        ...
        .rx-bg__orb--0 { width:700px;height:700px;top:-250px;left:-150px;background:rgba(255,60,172,0.1);animation:orb-drift 20s ease-in-out infinite,orb-pulse 7s ease-in-out infinite; }
        ...
        .rx-step-dot__circle--active { border-color:var(--p);color:var(--p);box-shadow:0 0 12px rgba(255,60,172,0.3); }
        .rx-step-dot__circle--done { background:var(--p);border-color:var(--p);box-shadow:0 0 16px rgba(255,60,172,0.4); }
        ...
        .rx-form-progress__fill { height:100%;background:var(--grad);border-radius:1px;transition:width 0.5s cubic-bezier(0.4,0,0.2,1);box-shadow:0 0 8px rgba(255,60,172,0.5); }
        ...
        .rx-field--on .rx-field__input { border-color:rgba(255,60,172,0.4);background:rgba(255,60,172,0.03);box-shadow:0 0 0 4px rgba(255,60,172,0.06); }
        ...
        .rx-submit {
          ...
          background:transparent;cursor:pointer;color:white;overflow:hidden;
        ...
        .rx-submit:hover { transform:translateY(-2px);box-shadow:0 20px 60px rgba(255,60,172,0.5); }
        ...
        .rx-social-btn:hover { border-color:rgba(255,60,172,0.3);color:var(--fg);background:rgba(255,60,172,0.04); }
