            ...
            <div className="register-card">
                ...
                <div className="register-heading">
                    <h1 className="register-title">
                        Start your<br/>
                        <span className="register-title--accent">journey.</span>
                    </h1>
                    <p className="register-subtitle">Create your account and start prepping smarter</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="register-form">
                    ...
                    <div className="field-wrap">
                        ...
                        <div className="field-inner">
                            <input
                                ...
                                className="field-input"
                            />
                            <span className="field-icon field-icon--clickable">
                                <svg width="15" height="15" fill="none" stroke="currentColor" strokeWidth="1.8"
                                     viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        <span className="submit-btn__text">Create Account</span>
                        <span className="submit-btn__shine"/>
                    </button>
