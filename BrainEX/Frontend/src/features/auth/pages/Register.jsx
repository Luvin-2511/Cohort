    ...
    const draw = () => {
      ...
      for (let s = 0; s < STRANDS; s++) {
        ...
        for (let i = 0; i < POINTS - 1; i++) {
          ...
          ctx.strokeStyle = `rgba(20,184,166,${alpha})`; ctx.lineWidth = 1.5; ctx.stroke();
...
function BrainLogo() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      <div>
        <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 20, fontWeight: 800, letterSpacing: "0.04em", color: "#f0fdf4", lineHeight: 1 }}>
          brain<span style={{ color: "#14b8a6" }}>EX</span>
        </div>
        <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 8, color: "#2dd4bf", letterSpacing: "0.2em", marginTop: 2 }}>
          INTELLIGENCE LAYER
        </div>
      </div>
    </div>
...
function SmartInput({ label, type = "text", value, onChange, hint, validate }) {
  ...
  useEffect(() => {
    gsap.to(lineRef.current, {
      ...
      background: showValid
        ? valid ? "linear-gradient(90deg, transparent, #22c55e, transparent)"
  ...
  const statusColor = showValid ? (valid ? "#22c55e" : "#ef4444") : focused ? "#14b8a6" : "rgba(255,255,255,0.07)";
  ...
  return (
    <div style={{ marginBottom: 18, position: "relative" }}>
      <label style={{
        ...
        color: focused ? "#14b8a6" : "#1f4e3d", marginBottom: 7,
        textTransform: "uppercase", transition: "color 0.2s",
      }}>
        {label}
        {hint && <span style={{ color: "#1f2937", fontWeight: 400, marginLeft: 8, textTransform: "none", letterSpacing: 0 }}>{hint}</span>}
      </label>
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...
            color: "#ecfdf5", fontFamily: "'Space Mono', monospace", fontSize: 13,
            outline: "none", transition: "border-color 0.2s",
            boxShadow: focused ? `0 0 0 3px ${showValid && !valid ? "rgba(239,68,68,0.08)" : "rgba(20,184,166,0.06)"}` : "none",
          }}
        />
        {showValid && (
          <span style={{
            position: "absolute", right: 14, top: "50%", transform: "translateY(-50%)",
            fontSize: 14, color: valid ? "#22c55e" : "#ef4444",
          }}>
            {valid ? "✓" : "✗"}
          </span>
        )}
  ...
  return (
    <div style={{ marginBottom: 18, padding: "14px 16px", background: "rgba(20,184,166,0.04)", border: "1px solid rgba(20,184,166,0.08)", borderRadius: 10 }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 9, color: "#374151", letterSpacing: "0.12em", textTransform: "uppercase" }}>
          Password Strength
        </span>
        <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 12, fontWeight: 700, color: colors[score] }}>
          {labels[score]}
        </span>
      </div>
      ...
      {Array.from({ length: total }).map((_, i) => (
        <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <div style={{
            ...
            background: i < current ? "linear-gradient(90deg, #14b8a6, #2dd4bf)"
              : i === current ? "rgba(20,184,166,0.3)" : "rgba(255,255,255,0.05)",
            border: i === current ? "1px solid rgba(20,184,166,0.4)" : "none",
            transition: "width 0.4s, background 0.3s",
          }} />
          {i < total - 1 && (
            <div style={{ width: 16, height: 1, background: i < current ? "rgba(20,184,166,0.4)" : "rgba(255,255,255,0.05)" }} />
          )}
        </div>
      ))}
      <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 9, color: "#1f4e3d", letterSpacing: "0.1em", marginLeft: 4 }}>
...
function Checkbox({ checked, onChange, children }) {
  ...
  const handle = () => {
    onChange(!checked);
    gsap.fromTo(boxRef.current, { scale: 0.85 }, { scale: 1, duration: 0.2, ease: "back.out(3)" });
  };
  return (
    <div onClick={handle} style={{ display: "flex", alignItems: "flex-start", gap: 12, cursor: "pointer", marginBottom: 18 }}>
      <div ref={boxRef} style={{
        ...
        border: `1.5px solid ${checked ? "#14b8a6" : "rgba(255,255,255,0.1)"}`,
        background: checked ? "rgba(20,184,166,0.15)" : "transparent",
        display: "flex", alignItems: "center", justifyContent: "center",
        marginTop: 1, transition: "border-color 0.2s, background 0.2s",
      }}>
        {checked && <span style={{ color: "#14b8a6", fontSize: 10 }}>✓</span>}
      </div>
      <span style={{ fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#374151", lineHeight: 1.7 }}>
        {children}
      </span>
    </div>
  );
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", minHeight: "100vh", background: "#020c09", overflow: "hidden", position: "relative" }}>
        ...
        {/* ══════════════ LEFT HELIX ══════════════ */}
        <div style={{
          width: 420, minWidth: 420, position: "relative", overflow: "hidden",
          ...
          <div style={{
            ...
            background: "linear-gradient(135deg, rgba(2,12,9,0.6) 0%, rgba(2,12,9,0.2) 100%)",
          ...
          {/* Center */}
          <div style={{ position: "relative", zIndex: 2 }}>
            <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 10, color: "#14b8a6", letterSpacing: "0.18em", marginBottom: 14 }}>
              // JOIN THE NETWORK
            </div>
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 42, fontWeight: 800, color: "#f0fdf4", lineHeight: 1.1, marginBottom: 20 }}>
              Your brain,
              <br />
              <span style={{ background: "linear-gradient(90deg, #14b8a6, #67e8f9)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                amplified.
              </span>
            </h2>
              ...
              {[
                ...
                <div key={text} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  <div style={{
                    ...
                    borderRadius: 8, color: "#14b8a6", fontSize: 14, flexShrink: 0,
                  }}>
                    {icon}
                  </div>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#374151", lineHeight: 1.8, marginBottom: 10 }}>
              "brainEX is what I always wished search engines could be. It thinks with you."
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ width: 28, height: 28, borderRadius: "50%", background: "linear-gradient(135deg, #14b8a6, #0891b2)", flexShrink: 0 }} />
              <div>
                <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 11, fontWeight: 700, color: "#2dd4bf" }}>Dr. Sarah Chen</div>
                <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 9, color: "#1f4e3d" }}>AI Researcher, MIT</div>
              </div>
              <div style={{ marginLeft: "auto", color: "#14b8a6", fontSize: 12, letterSpacing: 2 }}>★★★★★</div>
            </div>
          </div>
        </div>
        ...
        <div ref={rightRef} style={{
          ...
          padding: "32px 52px", position: "relative", zIndex: 2, overflowY: "auto",
        }}>
          <div ref={cardRef} style={{
            ...
            boxShadow: "0 32px 80px rgba(0,0,0,0.5), inset 0 1px 0 rgba(20,184,166,0.07)",
          }}>
            {/* Corner accents */}
            {[["top", "left"], ["top", "right"], ["bottom", "left"], ["bottom", "right"]].map(([v, h]) => (
              <div key={v + h} style={{
                position: "absolute", [v]: 0, [h]: 0, width: 28, height: 28,
                borderTop: v === "top" ? "1.5px solid rgba(20,184,166,0.35)" : "none",
                borderBottom: v === "bottom" ? "1.5px solid rgba(20,184,166,0.35)" : "none",
                borderLeft: h === "left" ? "1.5px solid rgba(20,184,166,0.35)" : "none",
                borderRight: h === "right" ? "1.5px solid rgba(20,184,166,0.35)" : "none",
              }} />
            ))}
            ...
            <div ref={headRef} style={{ marginBottom: 28 }}>
              ...
              <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 10, color: "#14b8a6", letterSpacing: "0.18em", marginBottom: 8 }}>
                CREATE ACCOUNT
              </div>
              <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 30, fontWeight: 800, color: "#ecfdf5", lineHeight: 1.1, marginBottom: 6 }}>
                Start exploring for free
              </h2>
              <p style={{ fontFamily: "'Space Mono', monospace", fontSize: 11, color: "#1f4e3d", lineHeight: 1.6 }}>
            ...
            <div ref={formRef}>
              ...
              <div style={{ display: "flex", gap: 14 }}>
                <div style={{ flex: 1 }}>
                  <SmartInput label="Full Name" value={name} onChange={e => setName(e.target.value)}
                    validate={v => v.trim().split(" ").length >= 2} />
                </div>
                <div style={{ flex: 1 }}>
                  <SmartInput label="Username" hint="@handle" value={username} onChange={e => setUsername(e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, ""))}
              ...
              <Checkbox checked={agreed} onChange={setAgreed}>
                I agree to the{" "}
                <span className="link-hover" style={{ color: "#14b8a6", cursor: "pointer" }}>Terms of Service</span>
                {" "}and{" "}
                <span className="link-hover" style={{ color: "#14b8a6", cursor: "pointer" }}>Privacy Policy</span>
              </Checkbox>
                ...
                {[["G", "Google"], ["⌘", "Apple"], ["𝕏", "Twitter"]].map(([icon, label]) => (
                  <button key={label}
                    style={{
                      ...
                      fontFamily: "'Space Mono', monospace", fontSize: 10, transition: "border-color 0.2s, color 0.2s",
                    }}
