...
Command: npx gltfjsx@6.5.3 public/scene.gltf -o Model.jsx 
    ...
    <group {...props} dispose={null}>
      <group scale={0.01}>
        ...
        <group rotation={[-Math.PI / 2, 0, 0]}>
          ...
          <mesh
            geometry={
              nodes.headlights_plastics_headlights_plastic_ring_0.geometry
            }
        ...
        <group rotation={[-Math.PI / 2, 0, 0]}>
          ...
          />
          <mesh
            geometry={nodes.plastic_all_bl_pl_M_int_0_1.geometry}
            material={materials.bl_pl_M_int}
          />
          <mesh
