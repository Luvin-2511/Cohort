...
const App = () => {
  ...
  return (
    <div className='flex m-[3rem] items-center gap-3 flex-wrap'>
      {arr.map((elem)=>{
        return <Card bgImage={elem.bgImage} likes={elem.likes} posts={elem.posts} views={elem.views} profile={elem.profile} name={elem.name} desc={elem.desc} />
      })}
    </div>
  )
}
