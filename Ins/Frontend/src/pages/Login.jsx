...
const Login = () => {
  ...
  const handleLoginForm = (e) => {
    e.preventDefault();
    const { usernameOrEmail, password } = e.target.elements;
          ...
          <div className="cont flex p-32 pt-36 items-center justify-center">
            ...
            >
              ...
              <div className="button relative bottom-[1.9vw]">
                <button className="bg-[#3441AF] text-sm rounded-md font-bold text-[#AFAFB3] py-[0.4vw] px-[6.8vw]">
                  Log in
                </button>
              </div>
              <div className="or flex items-center justify-center text-white gap-[1vw] relative bottom-[1vw] text-sm ">
                <div className="idhar w-[6.5vw] h-[0.05vw] bg-gray-800"></div>
                OR
                <div className="udhar  w-[6.5vw] h-[0.05vw] bg-gray-800"></div>
              </div>
              <div className="facebook text-md text-[#0095F6] cursor-pointer relative top-[1vw] flex items-center justify-center gap-[0.5vw]">
                <svg
              ...
              <div className="forgot cursor-pointer hover:underline text-white text-[0.85vw] relative top-[2vw] font-semibold">
                Forgot Password?
              </div>
