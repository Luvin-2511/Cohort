...
export default function RegisterPage() {
  ...
  const {loading,handleRegister,isCharacterSelected} = useAuth()
  ...
  const onSubmit = async (e) => {
    ...
    const response = await handleRegister(form.username,form.email,form.password)
    if(response.success && !isCharacterSelected){
