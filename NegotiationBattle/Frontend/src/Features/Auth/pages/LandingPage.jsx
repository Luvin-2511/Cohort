...
function Cursor() {
  ...
  return <div style={{
    height:'20px',
    width:'20px'
  }} ref={curRef} id="cursor" className={isBig ? "big" : ""} />;
}
  ...
  return (
    <section className="hero" id="hero">
      <div className="hero-left">
        ...
        >
          <button onClick={()=>{navigate('/login')}} className="btn-main magnetic"><span>⚔ ENTER ARENA</span></button>
